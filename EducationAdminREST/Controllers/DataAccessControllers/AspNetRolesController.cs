...
using EducationAdminREST.DataAccess;

namespace EducationAdminREST.Controllers.DataAccessControllers
{
    public class AspNetRolesController : ApiController
    {
        private sd21w1dlsUsersEntities db = new sd21w1dlsUsersEntities();
